...
class SGGravity (
     ...
     */
    fun <M_IN, M_OUT> addE(
        demandBuilder: DemandBuilder<M_IN, M_OUT>,
        ...
        var expectedTrips = expectedTrips
        ...
        /*if (demandBuilder.shape(mVar).first == 1) {
            expectedTrips = demandBuilder.diagAndMult(expectedTrips, mVar, tMatrixCar, relevantODs)
        } else {
